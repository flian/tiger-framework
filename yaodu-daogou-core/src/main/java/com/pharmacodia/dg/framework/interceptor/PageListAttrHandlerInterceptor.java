package com.pharmacodia.dg.framework.interceptor;

import com.github.miemiedev.mybatis.paginator.domain.PageList;
import com.pharmacodia.dg.framework.datamodel.Pager;
...
public class PageListAttrHandlerInterceptor extends HandlerInterceptorAdapter {
    public static String PAGINATOR="pager";
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (element instanceof String) {
                ...
                if (attr instanceof PageList) {
                    ...
                    request.setAttribute(PAGINATOR, Pager.toPager(pageList.getPaginator()));
                }
            }
        }
        if (modelAndView != null) {
            ...
            for (Map.Entry<String, Object> item : model.entrySet()) {
                ...
                if (attr instanceof PageList) {
                    ...
                    newModel.put(PAGINATOR, Pager.toPager(pageList.getPaginator()));
                }
            }
